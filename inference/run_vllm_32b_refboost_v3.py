...
TOP_K_RETRIEVE = 20   # reduced for speed (32B is 2× slower)
TOP_K_FINAL    = 7    # reduced for speed
SPARSE_WEIGHT  = 0.3
BM25_WEIGHT    = 0.2
...
def main():
    ...
    NEIGHBOR_THRESHOLD    = 0.20   # add ±1 neighbors above this (lowered from 0.30; EDA: 95% under-predict refs)
