...
PODMAN_ROOT="/dev/shm/podman-root3-${USER}"
PODMAN_RUN="/tmp/podman-run3-${USER}"
...
echo "=== [$(date)] Build start (14B DPO-v1) ==="
...
for attempt in 1 2 3 4 5; do
  ...
  podman push \
    ...
    --runroot="$PODMAN_RUN" \
    textsum-dpo:v1 \
    'registry.ai.in.th/2026-textsum/48f0b4ab/watin-promfiy.tme5:AI-Benchmark-Programs-2026-dpo-v1' && break
