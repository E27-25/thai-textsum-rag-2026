"""
32B DPO v2 training on top of Qwen3-32B-SFT-v1.
Input: dpo_pairs_32b_v2.json
Output: lora_output_dpo_32b_v2 → Qwen3-32B-DPO-v2
"""
import os
...
PAIRS_FILE = str(BASE / "dpo_pairs_32b_v2.json")
OUTPUT_DIR = str(BASE / "lora_output_dpo_32b_v2")
MAX_SEQ_LEN = 4096
SEED        = 42
