"""
32B SFT v2: balance between SFT v1 (7 distractors, IoU 0.635) and Oracle v1 (2 distractors, RougeL slightly lower).
  - 5 distractors (match inference TOP_K_FINAL=7 roughly)
  - Oracle refs last (most-relevant-last)
  - Correct system prompt (matches inference)
  - 4 epochs
  - Output: lora_output_32b_v2 → Qwen3-32B-SFT-v2
"""
import os
...
OUTPUT_DIR  = str(BASE / "lora_output_32b_v2")
